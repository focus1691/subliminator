...
public class JFontChooser extends JComponent {
	...
	Color choosen_color = new Color(0, 0, 0);
	...
	protected JDialog createDialog(final Component parent) {
		...
		colorButton.setFont(DEFAULT_FONT);
		...
		colorButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				Color newColor = JColorChooser.showDialog(parent, "Choose Message Color", parent.getBackground());
				if (newColor != null) {
					choosen_color = newColor;
				}
			}
		});
