...
public class InBuiltCategory {
	...
	public ArrayList<Category> getCateories() {
		...
		messages.add(new ArrayList<Message>(Arrays.asList(new Message[] {
				new Message("I never give up", "/images/7.jpg", default_font, default_color, false), new Message("I am strong", "/images/2.jpg", default_font, default_color, false),
				new Message("I don't care what others think about me", "/images/18.jpg", default_font, default_color, false),
				new Message("I stand out from the crowd", "/images/4.jpg", default_font, default_color, false),
				new Message("I will be successful", "/images/5.jpg", default_font, default_color, false),

				new Message("I have the power to achieve all of my dreams", "/images/6.jpg", default_font, default_color, false),
				new Message("I can do anything if I set my mind to it", "/images/7.jpg", default_font, default_color, false),
				new Message("I am the best at everything I do", "/images/8.jpg", default_font, default_color, false),
				new Message("I am strong-minded person", "/images/9.jpg", default_font, default_color, false),
				new Message("My dreams will become a reality", "/images/10.jpg", default_font, default_color, false),

				new Message("I have a bright future ahead of me", "/images/10.jpg", default_font, default_color, false),
				new Message("I focus on the positives in life", "/images/12.jpg", default_font, default_color, false),
				new Message("I am in control of my own destiny", "/images/13.jpg", default_font, default_color, false),
				new Message("I will climb to the top of the mountain", "/images/14.jpg", default_font, default_color, false),
				new Message("I am talented at influencing people", "/images/15.jpg", default_font, default_color, false),

				new Message("If I ruled the world it would be a better place", "/images/16.jpg", default_font, default_color, false),
				new Message("I can talk my way out of anything", "/images/17.jpg", default_font, default_color, false),
				new Message("I like to be the center of attention", "/images/18.jpg", default_font, default_color, false),
				new Message("I am a special person", "/images/19.jpg", default_font, default_color, false), new Message("I am assertive", "/images/20.jpg", default_font, default_color, false),

				new Message("I like to have authority over people", "/images/21.jpg", default_font, default_color, false),
				new Message("I find it easy to manipulate people", "/images/22.jpg", default_font, default_color, false),
				new Message("I demand respect from people", "/images/20.jpg", default_font, default_color, false),
				new Message("I can read people like a book", "/images/24.jpg", default_font, default_color, false),
				new Message("I am a role model to others", "/images/25.jpg", default_font, default_color, false),

				new Message("I love to show off", "/images/26.jpg", default_font, default_color, false),
				new Message("I remember everything that I read", "/images/27.jpg", default_font, default_color, false),
				new Message("I can recall facts with ease", "/images/28.jpg", default_font, default_color, false),
				new Message("I have a photographic memory", "/images/29.jpg", default_font, default_color, false),
				new Message("I find it easy to learn new information", "/images/28.jpg", default_font, default_color, false),

				new Message("I am a fast learner", "/images/28.jpg", default_font, default_color, false),
				new Message("I have a perfect memory", "/images/29.jpg", default_font, default_color, false),
				new Message("I am a genius", "/images/33.jpg", default_font, default_color, false),
				new Message("I have a high attention span", "/images/34.jpg", default_font, default_color, false),
				new Message("I have fast reactions", "/images/35.jpg", default_font, default_color, false),

				new Message("I am excellent at solving problems", "/images/36.jpg", default_font, default_color, false),
				new Message("I have a beautiful mind", "/images/33.jpg", default_font, default_color, false),
				new Message("I have an vivid imagination", "/images/33.jpg", default_font, default_color, false),
				new Message("I am a creative visionary", "/images/33.jpg", default_font, default_color, false),
				new Message("I am always thinking of new ideas", "/images/40.jpg", default_font, default_color, false),

				new Message("I am a beautiful person", "/images/41.jpg", default_font, default_color, false),
				new Message("I am proud of all my achievements", "/images/42.jpg", default_font, default_color, false),
				new Message("I have many talents", "/images/43.jpg", default_font, default_color, false),
				new Message("I like to be complimented", "/images/41.jpg", default_font, default_color, false),
				new Message("I am a natural born leader", "/images/25.jpg", default_font, default_color, false) })));

		// Add Self-enhancement messages (2nd person)
		messages.add(new ArrayList<Message>(Arrays.asList(new Message[] {
				new Message("You never give up", "/images/7.jpg", default_font, default_color, false), new Message("You are strong", "/images/2.jpg", default_font, default_color, false),
				new Message("You don't care what others think about you", "/images/18.jpg", default_font, default_color, false),
				new Message("You stand out from the crowd", "/images/4.jpg", default_font, default_color, false),
				new Message("You will be successful", "/images/5.jpg", default_font, default_color, false),

				new Message("You have the power to achieve all of your dreams", "/images/6.jpg", default_font, default_color, false),
				new Message("You can do anything if you set your mind to it", "/images/7.jpg", default_font, default_color, false),
				new Message("You are the best at everything you do", "/images/8.jpg", default_font, default_color, false),
				new Message("You are a strong-minded person", "/images/9.jpg", default_font, default_color, false),
				new Message("Your dreams will become a reality", "/images/10.jpg", default_font, default_color, false),

				new Message("You have a bright future ahead of you", "/images/10.jpg", default_font, default_color, false),
				new Message("You focus on the positives in life", "/images/12.jpg", default_font, default_color, false),
				new Message("You are in control of your own destiny", "/images/13.jpg", default_font, default_color, false),
				new Message("You will climb to the top of the mountain", "/images/14.jpg", default_font, default_color, false),
				new Message("You are talented at influencing people", "/images/15.jpg", default_font, default_color, false),

				new Message("If you ruled the world it would be a better place", "/images/16.jpg", default_font, default_color, false),
				new Message("You can talk your way out of anything", "/images/17.jpg", default_font, default_color, false),
				new Message("You like to be the center of attention", "/images/18.jpg", default_font, default_color, false),
				new Message("You are a special person", "/images/19.jpg", default_font, default_color, false),
				new Message("You are assertive", "/images/20.jpg", default_font, default_color, false),

				new Message("You like to have authority over people", "/images/21.jpg", default_font, default_color, false),
				new Message("You find it easy to manipulate people", "/images/22.jpg", default_font, default_color, false),
				new Message("You demand respect from people", "/images/20.jpg", default_font, default_color, false),
				new Message("You can read people like a book", "/images/24.jpg", default_font, default_color, false),
				new Message("You are a role model to others", "/images/25.jpg", default_font, default_color, false),

				new Message("You love to show off", "/images/26.jpg", default_font, default_color, false),
				new Message("You remember everything that you read", "/images/27.jpg", default_font, default_color, false),
				new Message("You can recall facts with ease", "/images/28.jpg", default_font, default_color, false),
				new Message("You have a photographic memory", "/images/29.jpg", default_font, default_color, false),
				new Message("You find it easy to learn new information", "/images/28.jpg", default_font, default_color, false),

				new Message("You are a fast learner", "/images/28.jpg", default_font, default_color, false),
				new Message("You have a perfect memory", "/images/29.jpg", default_font, default_color, false),
				new Message("You are a genius", "/images/33.jpg", default_font, default_color, false),
				new Message("You have a high attention span", "/images/34.jpg", default_font, default_color, false),
				new Message("You have fast reactions", "/images/35.jpg", default_font, default_color, false),

				new Message("You are excellent at solving problems", "/images/36.jpg", default_font, default_color, false),
				new Message("You have a beautiful mind", "/images/33.jpg", default_font, default_color, false),
				new Message("You have a vivid imagination", "/images/33.jpg", default_font, default_color, false),
				new Message("You are a creative visionary", "/images/33.jpg", default_font, default_color, false),
				new Message("You are always thinking of new ideas", "/images/40.jpg", default_font, default_color, false),

				new Message("You are a beautiful person", "/images/41.jpg", default_font, default_color, false),
				new Message("You are proud of all your achievements", "/images/42.jpg", default_font, default_color, false),
				new Message("You have many talents", "/images/43.jpg", default_font, default_color, false),
				new Message("You like to be complimented", "/images/41.jpg", default_font, default_color, false),
				new Message("You are a natural born leader", "/images/25.jpg", default_font, default_color, false) })));
