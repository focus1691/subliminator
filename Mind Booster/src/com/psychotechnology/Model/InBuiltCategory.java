...
public class InBuiltCategory {
	...
	public ArrayList<Category> getCateories() {
		...
		messages.add(new ArrayList<Message>(Arrays.asList(new Message[] {
				new Message("I never give up", "/Images/7.jpg"), new Message("I am strong", "/Images/2.jpg"),
				new Message("I don't care what others think about me", "/Images/18.jpg"),
				new Message("I stand out from the crowd", "/Images/4.jpg"),
				new Message("I will be successful", "/Images/5.jpg"),

				new Message("I have the power to achieve all of my dreams", "/Images/6.jpg"),
				new Message("I can do anything if I set my mind to it", "/Images/7.jpg"),
				new Message("I am the best at everything I do", "/Images/8.jpg"),
				new Message("I am strong-minded person", "/Images/9.jpg"),
				new Message("My dreams will become a reality", "/Images/10.jpg"),

				new Message("I have a bright future ahead of me", "/Images/10.jpg"),
				new Message("I focus on the positives in life", "/Images/12.jpg"),
				new Message("I am in control of my own destiny", "/Images/13.jpg"),
				new Message("I will climb to the top of the mountain", "/Images/14.jpg"),
				new Message("I am talented at influencing people", "/Images/15.jpg"),

				new Message("If I ruled the world it would be a better place", "/Images/16.jpg"),
				new Message("I can talk my way out of anything", "/Images/17.jpg"),
				new Message("I like to be the center of attention", "/Images/18.jpg"),
				new Message("I am a special person", "/Images/19.jpg"), new Message("I am assertive", "/Images/20.jpg"),

				new Message("I like to have authority over people", "/Images/21.jpg"),
				new Message("I find it easy to manipulate people", "/Images/22.jpg"),
				new Message("I demand respect from people", "/Images/20.jpg"),
				new Message("I can read people like a book", "/Images/24.jpg"),
				new Message("I am a role model to others", "/Images/25.jpg"),

				new Message("I love to show off", "/Images/26.jpg"),
				new Message("I remember everything that I read", "/Images/27.jpg"),
				new Message("I can recall facts with ease", "/Images/28.jpg"),
				new Message("I have a photographic memory", "/Images/29.jpg"),
				new Message("I find it easy to learn new information", "/Images/28.jpg"),

				new Message("I am a fast learner", "/Images/28.jpg"),
				new Message("I have a perfect memory", "/Images/29.jpg"),
				new Message("I am a genius", "/Images/33.jpg"),
				new Message("I have a high attention span", "/Images/34.jpg"),
				new Message("I have fast reactions", "/Images/35.jpg"),

				new Message("I am excellent at solving problems", "/Images/36.jpg"),
				new Message("I have a beautiful mind", "/Images/33.jpg"),
				new Message("I have an vivid imagination", "/Images/33.jpg"),
				new Message("I am a creative visionary", "/Images/33.jpg"),
				new Message("I am always thinking of new ideas", "/Images/40.jpg"),

				new Message("I am a beautiful person", "/Images/41.jpg"),
				new Message("I am proud of all my achievements", "/Images/42.jpg"),
				new Message("I have many talents", "/Images/43.jpg"),
				new Message("I like to be complimented", "/Images/41.jpg"),
				new Message("I am a natural born leader", "/Images/25.jpg") })));

		// Add Self-enhancement messages (2nd person)
		messages.add(new ArrayList<Message>(Arrays.asList(new Message[] {
				new Message("You never give up", "/Images/7.jpg"), new Message("You are strong", "/Images/2.jpg"),
				new Message("You don't care what others think about you", "/Images/18.jpg"),
				new Message("You stand out from the crowd", "/Images/4.jpg"),
				new Message("You will be successful", "/Images/5.jpg"),

				new Message("You have the power to achieve all of your dreams", "/Images/6.jpg"),
				new Message("You can do anything if you set your mind to it", "/Images/7.jpg"),
				new Message("You are the best at everything you do", "/Images/8.jpg"),
				new Message("You are a strong-minded person", "/Images/9.jpg"),
				new Message("Your dreams will become a reality", "/Images/10.jpg"),

				new Message("You have a bright future ahead of you", "/Images/10.jpg"),
				new Message("You focus on the positives in life", "/Images/12.jpg"),
				new Message("You are in control of your own destiny", "/Images/13.jpg"),
				new Message("You will climb to the top of the mountain", "/Images/14.jpg"),
				new Message("You are talented at influencing people", "/Images/15.jpg"),

				new Message("If you ruled the world it would be a better place", "/Images/16.jpg"),
				new Message("You can talk your way out of anything", "/Images/17.jpg"),
				new Message("You like to be the center of attention", "/Images/18.jpg"),
				new Message("You are a special person", "/Images/19.jpg"),
				new Message("You are assertive", "/Images/20.jpg"),

				new Message("You like to have authority over people", "/Images/21.jpg"),
				new Message("You find it easy to manipulate people", "/Images/22.jpg"),
				new Message("You demand respect from people", "/Images/20.jpg"),
				new Message("You can read people like a book", "/Images/24.jpg"),
				new Message("You are a role model to others", "/Images/25.jpg"),

				new Message("You love to show off", "/Images/26.jpg"),
				new Message("You remember everything that you read", "/Images/27.jpg"),
				new Message("You can recall facts with ease", "/Images/28.jpg"),
				new Message("You have a photographic memory", "/Images/29.jpg"),
				new Message("You find it easy to learn new information", "/Images/28.jpg"),

				new Message("You are a fast learner", "/Images/28.jpg"),
				new Message("You have a perfect memory", "/Images/29.jpg"),
				new Message("You are a genius", "/Images/33.jpg"),
				new Message("You have a high attention span", "/Images/34.jpg"),
				new Message("You have fast reactions", "/Images/35.jpg"),

				new Message("You are excellent at solving problems", "/Images/36.jpg"),
				new Message("You have a beautiful mind", "/Images/33.jpg"),
				new Message("You have a vivid imagination", "/Images/33.jpg"),
				new Message("You are a creative visionary", "/Images/33.jpg"),
				new Message("You are always thinking of new ideas", "/Images/40.jpg"),

				new Message("You are a beautiful person", "/Images/41.jpg"),
				new Message("You are proud of all your achievements", "/Images/42.jpg"),
				new Message("You have many talents", "/Images/43.jpg"),
				new Message("You like to be complimented", "/Images/41.jpg"),
				new Message("You are a natural born leader", "/Images/25.jpg") })));
